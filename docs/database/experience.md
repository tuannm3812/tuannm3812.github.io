...
This file serves as the raw, detailed repository for all professional roles. Use this as the main reference when selecting bullets and framing roles for customized resumes.
