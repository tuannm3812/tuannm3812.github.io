...
| [NFL Player Contact Detection](https://github.com/tuannm3812/kaggle-nfl-player-contact-detection) | Sports ML workflow using tracking features, helmet-derived video probes, temporal smoothing, type-specific models, and LightGBM blending. |
